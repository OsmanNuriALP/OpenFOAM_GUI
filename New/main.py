...
from PyQt6.QtGui import QAction, QPixmap, QColor, QFont , QIcon , QTextCursor , QImage
...
"padding: 7px 7px;")
        ...
        self.text_edit.append(initial_text)
...
"padding: 1px 1px;")
        ...
        post_process_menu=  menubar.addMenu('Post Processes')

        #VTK file is shown on paraview
        show_vtk_para_action = QAction("Show VTK on Paraview" , self)
        show_vtk_para_action.triggered.connect(self.show_vtk_paraview)
        post_process_menu.addAction(show_vtk_para_action)
        ...
        self.show()
    def show_vtk_paraview(self):
        vtk=VtkScreen.VtkScreen(self.current_project_directory)
        vtk.exec()
